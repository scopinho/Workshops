...
Digamos que criamos um grupo utilizando os parênteses ( ) que contenha apenas letra "a". 
Seu código ficaria **(a)**, e ele poderia ser referenciado com \\**\\1**, pois foi o primeiro grupo a ser criado.
